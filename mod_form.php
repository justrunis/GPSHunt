...
/**
 * The main mod_gpshunt configuration form.
 *
 * @package     mod_gpshunt
 ...
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_gpshunt_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('gpshuntname', 'mod_gpshunt'), array('size' => '64'));
        ...
        $mform->addHelpButton('name', 'gpshuntname', 'mod_gpshunt');
